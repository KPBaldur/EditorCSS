  ...
  return (
    <header className="flex items-center justify-between border-b border-white/5 bg-background-dark px-6 py-3 shrink-0">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-sm font-bold tracking-tight text-white uppercase leading-none">Editor de estilos Nexus</h1>
          <p className="text-[10px] text-slate-500 font-mono tracking-widest mt-1">v1.0.0-beta</p>
        </div>
      </div>

      <div className="flex items-center gap-6">
        <nav className="flex gap-6">
          <a className="text-xs font-medium text-slate-400 hover:text-white transition-colors" href="#">Proyecto</a>
          <a className="text-xs font-medium text-slate-400 hover:text-white transition-colors" href="#">Configuración</a>
          <a className="text-xs font-medium text-slate-400 hover:text-white transition-colors" href="#">Documentación</a>
        </nav>
